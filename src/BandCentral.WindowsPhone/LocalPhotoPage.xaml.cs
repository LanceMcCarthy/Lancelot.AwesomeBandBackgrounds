...
{
    public sealed partial class LocalPhotoPage : Page, IFileOpenPickerContinuable
    {
        ...
        private async Task<WriteableBitmap> ApplyCropAsync(Rect cropRectangleGeometryFromUI)
        {
            try
            {
                ...
                using (var source = bitmapSource)
                {
                    ...
                    {
                        filters.Filters = new IFilter[] { new CropFilter(croppingBounds) };
        ...
        //private async Task<bool> SetBandImageAsync(WriteableBitmap outputWb)
        //{
        //    if(outputWb == null) return false;
        ...
        //    if(exception != null)
        //    {
        //        await new MessageDialog("Sorry, there was a problem sending image to the Microsoft Band: " + exception.Message).ShowAsync();
        //    }
