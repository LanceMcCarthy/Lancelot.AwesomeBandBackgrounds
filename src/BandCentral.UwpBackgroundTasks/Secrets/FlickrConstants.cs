namespace BandCentral.UwpBackgroundTasks.Secrets
{
    internal static class FlickrConstants
    {
        //filenames
        ...
        public const string WindowsDevFlickrApiKey = "";
        public const string WindowsDevFlickrSharedSecret = "";
